...
ax0.set_title('HSC Deep', fontsize=42)
ax0.set_xlabel('r-z', fontsize=45)
ax0.set_ylabel('g-r', fontsize=45)
...
ax0.plot([0.15,0.15], [-10, y_slope_plus[0]], ls='--',linewidth=4, color='black')
ax0.plot(x_slope_plus, y_slope_plus, ls='--', color='black',linewidth=4, label='DESI LOP')
ax0.plot(x_slope_minus, y_slope_minus, ls='--',linewidth=4, color='black')

# draw truth selection cuts
ax0.plot([-0.5, truth_neg_x[0]], [0.8, 0.8], ls='-',linewidth=4, color='black')
ax0.plot(truth_neg_x, truth_neg_y, ls='-',linewidth=4, color='black')

ax1.set_title('HSC Wide', fontsize=42)
ax1.set_xlabel('r-z', fontsize=45)
...
# draw DESI1 ELG selection cuts 
ax1.plot([0.15,0.15], [-10, y_slope_plus[0]], ls='--',linewidth=4,  color='black')
ax1.plot(x_slope_plus, y_slope_plus, ls='--',linewidth=4,  color='black', label='DESI LOP')
ax1.plot(x_slope_minus, y_slope_minus, ls='--',linewidth=4,  color='black')

# draw truth sample selection cuts
ax1.plot([-0.5, truth_neg_x[0]], [0.8, 0.8], ls='-',linewidth=4,  color='black')
ax1.plot(truth_neg_x, truth_neg_y, ls='-',linewidth=4,  color='black')
...
cbar.set_label(f'Spectroscopic redshift', fontsize=42, loc='center')
plt.savefig('/Users/yokisalcedo/Desktop/Emission-Line-Galaxy-Target-Selection/script_figure_truth/color_color_hsc_wide_vs_deep.png', dpi=300)
