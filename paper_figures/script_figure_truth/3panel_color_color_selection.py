...
optimization_csv_path = optimization_csv_path = '/Users/yokisalcedo/Desktop/Emission-Line-Galaxy-Target-Selection/data/optimization_results/spec_truth/1-1_1-6_opt_params.csv'
...
sd0 = ax0.scatter(ri_rongpu, iy_rongpu, c = specz_rongpu, cmap = cmap, s = 12, alpha = 0.1 , lw=2, vmin=vmin, vmax=vmax)
sd1 = ax1.scatter(ri_rongpu, iz_rongpu, c = specz_rongpu, cmap = cmap, s = 12, alpha = 0.1 , lw=2, vmin=vmin, vmax=vmax)
sd2 = ax2.scatter(iy_rongpu, iz_rongpu, c = specz_rongpu, cmap = cmap, s = 12, alpha = 0.1 , lw=2, vmin=vmin, vmax=vmax)
...
ax0.set_xlabel('r-i', fontsize = 40)
ax0.set_ylabel('i-y', fontsize = 40)
ax0.set_xlim(*ri_lim)
ax0.set_ylim(*iy_lim)
x_new = np.arange(0.35 + iyshift , 2, .05)
y_new = x_new - 0.19 + rishift
ax0.plot(y_new, x_new, c = 'black', linewidth=4) 
ax0.axhline(y = 0.35 + iyshift , xmax = x_new[0] - 0.05 ,linewidth=4, c = 'black')  
...
ax1.set_xlabel('r-i', fontsize = 40)
ax1.set_ylabel('i-z', fontsize = 40)
ax1.xaxis.set_tick_params(labelsize = 25)
ax1.yaxis.set_tick_params(labelsize = 25)
ax1.set_xlim(*ri_lim)
ax1.set_ylim(*iz_lim)
ax1.axhline(y = izmin ,linewidth=4, color='black')
ax1.arrow(0.40, izmin, 0, 0.2, head_width=0.05, color=arrow_color)

ax2.set_xlabel('i-y', fontsize = 40)
ax2.set_ylabel('i-z', fontsize = 40)
...
ax2.set_xlim(*iy_lim)
ax2.set_ylim(*iz_lim)
ax2.axhline(y = izmin, xmin=0.35 - iyshift + 0.03, linewidth=4,  color='black')
ax2.axvline(x = 0.35 + iyshift ,linewidth=4, color='black', ymin=izmin + 0.08)
...
cbar.set_label('Spectroscopic redshift', fontsize = 40, loc='center')
plt.savefig('/Users/yokisalcedo/Desktop/Emission-Line-Galaxy-Target-Selection/paper_figures/script_figure_truth/3panel_color_color_selection.png', dpi = 300, bbox_inches='tight')
