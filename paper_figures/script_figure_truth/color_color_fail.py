...
dir_in_cosmos = '/Users/yokisalcedo/Desktop/Emission-Line-Galaxy-Target-Selection/data/processed/hdf5/cosmos2020.hdf5'
cat_cosmos = read_table_hdf5(dir_in_cosmos)
...
ax0.plot(y_new, x_new, c = 'black', lw=4) 
ax0.axhline(y = 0.35 + iyshift , xmax = x_new[0] - 0.05 , c = 'black', lw=4)  
...
ax1.set_xlim(*ri_lim)
ax1.set_ylim(*iz_lim)
ax1.axhline(y = izmin , color='black', lw=4)
...
ax2.set_xlim(*iy_lim)
ax2.set_ylim(*iz_lim)
ax2.axhline(y = izmin, xmin=0.35 - iyshift + 0.03,  color='black', lw=4)
ax2.axvline(x = 0.35 + iyshift , color='black',  ymin=izmin + 0.08,lw=4)
...
cbar.set_label('Lephare photo-z', fontsize= 40, loc='center')
plt.savefig('/Users/yokisalcedo/Desktop/Emission-Line-Galaxy-Target-Selection/paper_figures/script_figure_truth/color_color_fail.png', dpi=300, bbox_inches='tight' )
