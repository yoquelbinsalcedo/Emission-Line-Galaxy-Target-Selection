...
path_fig = f'/Users/yokisalcedo/Desktop/Emission-Line-Galaxy-Target-Selection/analysis/figures/cosmos2020/roc_curve_all_feature_{z_range[0]}_{z_range[1]}.png'
...
predict_prob_test = clf.predict_proba(X_test)[:, 1]
...
fig, ax = plt.subplots()
ax.plot(fpr, tpr, label=f'{z_range[0]} < z < {z_range[1]} with all features on test set')
