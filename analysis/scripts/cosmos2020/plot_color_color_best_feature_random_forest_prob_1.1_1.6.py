...
path_fig = f'/Users/yokisalcedo/Desktop/Emission-Line-Galaxy-Target-Selection/analysis/figures/cosmos2020/color_color_rf_prob_{z_range[0]}_{z_range[1]}.png'
...
sd0 = ax0.scatter(ri, iy, c=predict_prob, cmap=cmap, s=12, alpha=0.1, vmin=vmin, vmax=vmax)
sd1 = ax1.scatter(ri, iz, c=predict_prob, cmap=cmap, s=12, alpha=0.1, vmin=vmin, vmax=vmax)
sd2 = ax2.scatter(iy, iz, c=predict_prob, cmap=cmap, s=12, alpha=0.1, vmin=vmin, vmax=vmax)
sdummy = ax1.scatter(x=100, y=100, c=predict_prob[0], cmap=cmap, s=12, alpha=1, vmin=vmin, vmax=vmax)
...
cbar = plt.colorbar(sdummy, ax=[ax0, ax1, ax2], orientation='horizontal',  shrink=0.75)
cbar.ax.tick_params(labelsize=16)
cbar.set_label(f'RF probability of being within {z_range[0]} < z < {z_range[1]}', fontsize=27, loc='center')
