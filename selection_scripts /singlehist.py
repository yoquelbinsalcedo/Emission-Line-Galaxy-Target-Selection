...
ax.hist(photoz[color_cuts], bins = np.linspace(0, 2, 100), histtype= 'step', color = 'blue', label = 'i-y/r-i cut ')
ax.axvline(x = 1.05,ls= '--', color='black')
ax.axvline(x = 1.55,ls= '--', color='black')
ax.set_xlabel('LePhare Photometric Redshift')
ax.set_ylabel('Count')
ax.legend(loc = 'upper left')

#save the figure as a png to the 'paperfigs' folder
plt.savefig('/Users/yokisalcedo/Desktop/Emission-Line-Galaxy-Target-Selection/paperfigs/broad_hist_iyri .png', dpi=300)
print('Figure saved')
