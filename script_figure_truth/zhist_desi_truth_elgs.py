...
ax.stairs(normhist_rongpu, edges, linewidth=2, color='blue', label='Spectroscopic truth')
ax.axvline(x=1.10,ls='--', color='black')
ax.axvline(x=1.60,ls='--', color='black')
ax.xaxis.set_tick_params(labelsize=16)
ax.yaxis.set_tick_params(labelsize=16)
ax.set_xlabel('Spec-z', fontsize=22)
ax.set_ylabel('Observed N [$deg^{-2}$]', fontsize=22)
ax.legend(loc='upper left', fontsize=16)
plt.savefig('/Users/yokisalcedo/Desktop/Emission-Line-Galaxy-Target-Selection/script_figure_truth/zhist_desi_truth_elgs.png', dpi=300, bbox_inches='tight')