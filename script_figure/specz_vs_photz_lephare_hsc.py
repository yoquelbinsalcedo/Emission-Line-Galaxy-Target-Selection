...
from astropy.coordinates import SkyCoord
 ...
 #function to use 
def plot_and_stats(z_spec, z_phot, z_spec_hsc, z_phot_hsc, ylabel, ylabel_hsc, vlinemin = 1.05, vlinemax = 1.65, filepath = '/Users/yokisalcedo/Desktop/Emission-Line-Galaxy-Target-Selection/script_figure/specz_vs_photz_lephare_hsc.png'):
...
#Percentage of delta-z > 0.15(1+z) outliers:
    ...
    #ax1 for the histogram
    ax3.hist(z_spec_hsc, bins = np.linspace(0, 2, 100), histtype= 'step', color = 'black', label = 'specz')
    ax3.hist(z_phot_hsc, bins = np.linspace(0, 2, 100), histtype= 'step', color = 'red', label = 'photoz')
...
photoz_hsc = combined_cat_hsc_pz['photoz_best']
specz_hsc = combined_cat_hsc_pz['Z']

plot_and_stats(specz_cos[snr_mask_comb_cos], photoz_cos[snr_mask_comb_cos], specz_hsc[snr_mask_comb_pz], photoz_hsc[snr_mask_comb_pz], ylabel='Cosmos2020 Lephare photoz', ylabel_hsc='HSC photoz' , vlinemin= 1.05, vlinemax = 1.65)
