...
#color color plots of our elgs that did not pass the snr and chi2 cuts
fig, (ax0, ax1) = plt.subplots(2, 1, figsize=(8, 15))
ax0.scatter(ri_fail, iy_fail, c = 'purple' , s = 5, alpha = 1)
ax1.scatter(iz_fail, iy_fail, c = 'purple' , s = 5, alpha = 1)
