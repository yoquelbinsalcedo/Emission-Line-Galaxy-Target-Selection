...
from astropy.coordinates import SkyCoord
 ...
 #function to use 
def plot_and_stats(z_spec,z_phot,ylabel,isvert,vlinemin = 1.05,vlinemax = 1.65,filepath = '/Users/yokisalcedo/Desktop/Emission-Line-Galaxy-Target-Selection/script_figure/spec_vs_phot_z_cosmos'):
...
plot_and_stats(specz_cos[snr_mask_comb_cos], photoz_cos[snr_mask_comb_cos], ylabel = 'Cosmos2020 photoz',isvert = True, vlinemin= 1.05, vlinemax = 1.65, filepath ='/Users/yokisalcedo/Desktop/Emission-Line-Galaxy-Target-Selection/script_figure/spec_vs_phot_cosmos.png')
