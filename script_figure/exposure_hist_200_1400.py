...
fig, ax = plt.subplots()
plt.hist(exposure[tmask], bins = 400, color = 'blue')
plt.xlim(0, 5000)
plt.ylim(0, 1500)
plt.xlabel('Exposure Time (s)', fontsize = 16)
plt.ylabel('Count', fontsize = 16)
plt.axvline(x = 1400, c = 'black')
plt.axvline(x = 200, c = 'black')
ax.xaxis.set_tick_params(labelsize = 12)
ax.yaxis.set_tick_params(labelsize = 12)
xfill = np.linspace(200, 1400,100)
yfill1 = np.linspace(1500, 1500,100)
yfill2 = np.linspace(0,0, 100)
ax.fill_between(xfill,yfill1,yfill2, color = 'grey', alpha = 0.5)
plt.savefig('/Users/yokisalcedo/Desktop/Emission-Line-Galaxy-Target-Selection/script_figure/exposure_hist_200_1400', dpi = 300)
