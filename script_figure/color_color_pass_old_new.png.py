...
ax0.plot(x_new -0.19 ,x_new, c = 'black') 
ax0.plot(x_ -0.19 ,x_ ,ls = '--', c = 'black') 
ax0.axhline(y = 0.35, ls = '--', xmax = 0.43 , c = 'black') 
ax0.axhline(y = 0.35 + 0.05636818841724967 , xmax = 0.4755 , c = 'black')  
...
ax1.axvline(x = 0.37442580263398095 , ls= '-', color='black') 
ax1.axhline(y = 0.35 + 0.05636818841724967 , color='black')
ax1.axhline(y = 0.35, ls = '--', c = 'black') 
...
plt.savefig('/Users/yokisalcedo/Desktop/Emission-Line-Galaxy-Target-Selection/script_figure/color_color_pass_old_new.png', dpi = 300, bbox_inches='tight' )
